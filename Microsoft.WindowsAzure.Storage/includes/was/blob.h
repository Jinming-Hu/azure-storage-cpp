...
namespace azure { namespace storage {
    ...
    struct blob_listing_details
    {
        enum values
        {
            ...
            /// <summary>
            /// List all available committed blobs, uncommitted blobs, and snapshots, and versions, and return all metadata and copy status for those blobs.
            /// </summary>
            all = snapshots | metadata | uncommitted_blobs | copy | versions
        };
    };
